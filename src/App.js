...
function App() {
        ...
        <div className='Skills'>
          ...
          <span style={{fontSize:"1.3em"}}>
            ...
            <ul style={{textAlign:"left"}}>
              <li><b>
                <div data-aos-once="false" data-aos="fade-right" data-aos-offset="-550" data-aos-duration="500" data-aos-delay="0" style={{display:"inline-block"}}>Fast:</div>
                </b>performance such as optimizing images and minifying CSS and JavaScript</li>
              <li><b><div data-aos-once="false" data-aos="fade-down" data-aos-offset="-550" data-aos-duration="1500" data-aos-delay="50" style={{display:"inline-block"}}>Res</div>
                      <div data-aos-once="false" data-aos="fade-down" data-aos-offset="-550" data-aos-duration="1500" data-aos-delay="100" style={{display:"inline-block"}}>pons</div> 
                      <div data-aos-once="false" data-aos="fade-down" data-aos-offset="-550" data-aos-duration="1500" data-aos-delay="150" style={{display:"inline-block"}}>ive:</div> 
                      </b>understanding of UI/UX best practices and responsive design</li>
              {/* <li>excellent debugging skills with dev tools and coding best practices</li> */}
              <li><b>
                <div data-aos-once="false" data-aos="flip-up" data-aos-offset="-550" data-aos-duration="2000" data-aos-delay="500" style={{display:"inline-block"}}>Dy</div>
                <div data-aos-once="false" data-aos="fade-up-left" data-aos-offset="-550" data-aos-duration="1000" data-aos-delay="500" style={{display:"inline-block"}}>na</div>
                <div data-aos-once="false" data-aos="fade-up-right" data-aos-offset="-550" data-aos-duration="500" data-aos-delay="500" style={{display:"inline-block"}}>mic:</div>
              </b>
              websites can be much more interesting , i love making pages come to life.</li>
            </ul>
            </div>
          ...
          <br></br>
            ...
            <div data-aos-offset="-550" data-aos="fade-left" data-aos-delay="600"><img className='imagenround' src={javas}></img><div style={{textAlign:"center"}}>JavaScript (ES6+)</div></div>
            <div data-aos-offset="-550" data-aos="fade-left" data-aos-delay="650"><div style={{width:"90px",height:"90px",display:"flex",justifyContent:"center",alignItems:"center"}}><img style={{width:"84px"}} className='imagen' src={ts}></img></div><div style={{textAlign:"center"}}>Typescript</div></div>
            <div data-aos-offset="-550" data-aos="fade-left" data-aos-delay="700"><img className='imagenround' src={reactl}></img><div style={{textAlign:"center"}}>React</div></div>
            <div data-aos-offset="-550" data-aos="fade-left" data-aos-delay="750"><img className='imagen' src={next}></img><div style={{textAlign:"center"}}>Next</div></div>
           


            <div data-aos-offset="-550" data-aos="fade-left" data-aos-delay="800"><img className='imagen' src={bootstrap}></img><div style={{textAlign:"center"}}>Bootstrap</div></div>
            <div data-aos-offset="-550" data-aos="fade-left" data-aos-delay="850"><img className='imagen' src={sass}></img><div style={{textAlign:"center"}}>Sass</div></div>


           <div data-aos-offset="-550" data-aos="fade-left" data-aos-delay="900"><img className='imagen imagenround' src={axi}></img><div style={{textAlign:"center"}}>Axios</div></div>     
           <div data-aos-offset="-550" data-aos="fade-left" data-aos-delay="950"><img className='imagen' src={red}></img><div style={{textAlign:"center"}}>Redux</div></div>     
            <div data-aos-offset="-550" data-aos="fade-left" data-aos-delay="1000"><img className='imagenround' src={reactrouterl}></img><div style={{textAlign:"center"}}>React Router</div></div> 
            {/* <div><img className='imagenround' src={reactrouterl}></img><div style={{textAlign:"center"}}>React Router</div></div> */}
            <div data-aos-offset="-550" data-aos="fade-left" data-aos-delay="1050"><img className='imagen' src={git}></img><div style={{textAlign:"center"}}>Git</div></div>     
          </div >
          <br></br>
  ...
  <div data-aos-offset="-600" data-aos="fade-right" data-aos-delay="1050"><div style={{width:"90px",height:"90px",display:"flex",justifyContent:"center",alignItems:"center"}}><img style={{width:"84px",borderRadius:"10px"}} className='imagen' src={mon}></img></div><div style={{textAlign:"center"}}>Mongodb</div></div>
  <div data-aos-offset="-600" data-aos="fade-right" data-aos-delay="1150"><div style={{width:"90px",height:"90px",display:"flex",justifyContent:"center",alignItems:"center"}}><img style={{width:"84px"}} className='imagen' src={node}></img></div><div style={{textAlign:"center"}}>Node</div></div>
  <div data-aos-offset="-600" data-aos="fade-right" data-aos-delay="1250"><div style={{width:"90px",height:"90px",display:"flex",justifyContent:"center",alignItems:"center"}}><img style={{width:"84px",borderRadius:"10px"}} className='imagen' src={ex}></img></div><div style={{textAlign:"center"}}>Express</div></div>
  <div data-aos-offset="-600" data-aos="fade-right" data-aos-delay="1350"><div style={{width:"90px",height:"90px",display:"flex",justifyContent:"center",alignItems:"center"}}><img style={{width:"180px"}} className='imagen' src={graph}></img></div><div style={{textAlign:"center"}}>GraphQL</div></div>
            <div data-aos-offset="-600" data-aos="fade-right" data-aos-delay="1450"><img className='imagen' src={mog}></img><div style={{textAlign:"center"}}>Mongoose</div></div>     
      ...
      <div className='arrow-up3'></div>
        ...
        Some of my <u>projects</u>:<br></br>
          ...
          <br></br>
          <div style={{gap:"10px" }} className='d-flex flex-wrap justify-content-center'>
           <div data-aos="fade-up" data-aos-offset="-650" data-aos-duration="1000"  >
